      ...
      <table>
        ...
        <tbody>
          <tr v-for="product in products">
            ...
            <td>
              <GenericButton @click="handleModify(product)" class="btnModificar hover:bg-blue-400">Modificar</GenericButton>
              <GenericButton @click="handleDelete(product.id)" class="btnBorrar hover:bg-red-400">Borrar</GenericButton>
            </td>
            <td><input type="number" name="cantidadAnadir" :id="'cantidadAnadir-'+product.id" min="1" :max="product.stock" value="1"><GenericButton @click="handleAddProduct(product)" class="hover:bg-green-400">Añadir</GenericButton></td>
          </tr> 
        </tbody>
      </table>
    </div>
      ...
      <table v-if="productsCart.length != 0">
        ...
        <tbody>
          <tr v-for="(product, index) in productsCart">
            ...
            <td>
              <GenericButton @click="handleDeleteProductCart(index)" class="btnBorrar hover:bg-red-400">Borrar</GenericButton>
            </td>
          </tr>
        </tbody>
        <tfoot>
